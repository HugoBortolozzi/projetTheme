                ...
                <div class="col-md-4">
                    <div class="footer-col middle">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Read our <a class="turquoise" href="<?php echo get_template_directory_uri(); ?>/terms-conditions.php">Terms & Conditions</a>, <a class="turquoise" href="<?php echo get_template_directory_uri(); ?>/privacy-policy.php">Privacy Policy</a></div>
                            </li>
                        </ul>
                    </div>
                </div> <!-- end of col -->
